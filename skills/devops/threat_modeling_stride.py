"""Skill: Threat Modeling STRIDE — Migración automática de 21_threat_modeling_stride.md."""
from core.skills.base import BaseSkill


class ThreatModelingStrideSkill(BaseSkill):
    """Threat Modeling STRIDE."""

    name = "Threat Modeling STRIDE"
    agency = "DevOps"
    keywords = ['amenaza', 'stride', 'threat', 'seguridad', 'riesgo', 'ataque', 'vulnerabilidad']

    def get_instructions(self) -> str:
        return """## Threat Modeling STRIDE

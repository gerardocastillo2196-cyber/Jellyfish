"""Skill: Dockerfile Optimization — Migración automática de 22_dockerfile_optimization.md."""
from core.skills.base import BaseSkill


class DockerfileOptimizationSkill(BaseSkill):
    """Dockerfile Optimization."""

    name = "Dockerfile Optimization"
    agency = "DevOps"
    keywords = ['dockerfile', 'docker', 'contenedor', 'imagen', 'multi-stage', 'build', 'capas']

    def get_instructions(self) -> str:
        return """## Dockerfile Optimization

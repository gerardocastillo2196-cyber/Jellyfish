"""Skill: CI/CD Pipeline Design — Migración automática de 23_cicd_pipeline_design.md."""
from core.skills.base import BaseSkill


class CicdPipelineDesignSkill(BaseSkill):
    """CI/CD Pipeline Design."""

    name = "CI/CD Pipeline Design"
    agency = "DevOps"
    keywords = ['ci/cd', 'pipeline', 'github actions', 'jenkins', 'despliegue', 'integración continua']

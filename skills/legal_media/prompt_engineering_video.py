"""Skill: Prompt Engineering for Video — Migración automática de 49_prompt_engineering_video.md."""
from core.skills.base import BaseSkill


class PromptEngineeringVideoSkill(BaseSkill):
    """Prompt Engineering for Video."""

    name = "Prompt Engineering for Video"
    agency = "Legal & Media"
    keywords = ['prompt', 'prompt engineering', 'video', 'ia generativa', 'dalle', 'midjourney']

    def get_instructions(self) -> str:
        return """## Prompt Engineering for Video

"""Skill: SLA Drafting — Migración automática de 43_sla_drafting.md."""
from core.skills.base import BaseSkill


class SlaDraftingSkill(BaseSkill):
    """SLA Drafting."""

    name = "SLA Drafting"
    agency = "Legal & Media"
    keywords = ['sla', 'acuerdo de nivel', 'uptime', 'disponibilidad', 'penalización', 'contrato']

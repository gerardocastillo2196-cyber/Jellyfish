"""Skill: GDPR Compliance Audit — Migración automática de 39_gdpr_compliance_audit.md."""
from core.skills.base import BaseSkill


class GdprComplianceAuditSkill(BaseSkill):
    """GDPR Compliance Audit."""

    name = "GDPR Compliance Audit"
    agency = "Legal & Media"
    keywords = ['gdpr', 'privacidad', 'datos personales', 'consentimiento', 'dpo', 'lopd']

    def get_instructions(self) -> str:
        return """## GDPR Compliance Audit

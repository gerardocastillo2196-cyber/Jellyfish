"""Skill: Microservices Boundary — Migración automática de 10_microservices_boundary.md."""
from core.skills.base import BaseSkill


class MicroservicesBoundarySkill(BaseSkill):
    """Microservices Boundary."""

    name = "Microservices Boundary"
    agency = "Development"
    keywords = ['microservicios', 'microservice', 'bounded context', 'servicio', 'api gateway', 'desacoplar']

    def get_instructions(self) -> str:
        return """## Microservices Boundary

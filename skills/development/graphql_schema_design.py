"""Skill: GraphQL Schema Design — Migración automática de 13_graphql_schema_design.md."""
from core.skills.base import BaseSkill


class GraphqlSchemaDesignSkill(BaseSkill):
    """GraphQL Schema Design."""

    name = "GraphQL Schema Design"
    agency = "Development"
    keywords = ['graphql', 'schema', 'query', 'mutation', 'subscription', 'resolver', 'apollo']

    def get_instructions(self) -> str:
        return """## GraphQL Schema Design

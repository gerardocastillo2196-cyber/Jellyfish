"""Skill: TDD Methodology — Migración automática de 11_tdd_methodology.md."""
from core.skills.base import BaseSkill


class TddMethodologySkill(BaseSkill):
    """TDD Methodology."""

    name = "TDD Methodology"
    agency = "Development"
    keywords = ['tdd', 'test driven', 'pruebas', 'testing', 'red green refactor', 'unit test', 'pytest', 'jest']

    def get_instructions(self) -> str:
        return """## TDD Methodology

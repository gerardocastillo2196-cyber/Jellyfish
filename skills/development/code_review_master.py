"""Skill: Code Review Master — Migración automática de 12_code_review_master.md."""
from core.skills.base import BaseSkill


class CodeReviewMasterSkill(BaseSkill):
    """Code Review Master."""

    name = "Code Review Master"
    agency = "Development"
    keywords = ['code review', 'revisión de código', 'pull request', 'PR', 'merge request', 'refactorización']

    def get_instructions(self) -> str:
        return """## Code Review Master

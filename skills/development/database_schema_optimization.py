"""Skill: Database Schema Optimization — Migración automática de 08_database_schema_optimization.md."""
from core.skills.base import BaseSkill


class DatabaseSchemaOptimizationSkill(BaseSkill):
    """Database Schema Optimization."""

    name = "Database Schema Optimization"
    agency = "Development"
    keywords = ['base de datos', 'esquema', 'sql', 'postgresql', 'mysql', 'mongodb', 'índice', 'normalización', 'query', 'orm']

    def get_instructions(self) -> str:
        return """## Database Schema Optimization

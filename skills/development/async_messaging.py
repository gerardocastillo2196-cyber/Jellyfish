"""Skill: Async Messaging — Migración automática de 15_async_messaging.md."""
from core.skills.base import BaseSkill


class AsyncMessagingSkill(BaseSkill):
    """Async Messaging."""

    name = "Async Messaging"
    agency = "Development"
    keywords = ['kafka', 'rabbitmq', 'mensajería', 'async', 'eventos', 'pub/sub', 'cola', 'queue', 'streaming']

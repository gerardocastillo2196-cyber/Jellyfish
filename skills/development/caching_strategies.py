"""Skill: Caching Strategies — Migración automática de 14_caching_strategies.md."""
from core.skills.base import BaseSkill


class CachingStrategiesSkill(BaseSkill):
    """Caching Strategies."""

    name = "Caching Strategies"
    agency = "Development"
    keywords = ['cache', 'redis', 'memcached', 'caching', 'ttl', 'invalidación', 'cdn']

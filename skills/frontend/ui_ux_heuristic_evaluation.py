"""Skill: UI/UX Heuristic Evaluation — Migración automática de 16_ui_ux_heuristic_evaluation.md."""
from core.skills.base import BaseSkill


class UiUxHeuristicEvaluationSkill(BaseSkill):
    """UI/UX Heuristic Evaluation."""

    name = "UI/UX Heuristic Evaluation"
    agency = "Frontend"
    keywords = ['heurísticas', 'nielsen', 'usabilidad', 'ux', 'evaluación', 'interfaz']

    def get_instructions(self) -> str:
        return """## UI/UX Heuristic Evaluation

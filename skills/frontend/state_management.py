"""Skill: State Management — Migración automática de 20_state_management.md."""
from core.skills.base import BaseSkill


class StateManagementSkill(BaseSkill):
    """State Management."""

    name = "State Management"
    agency = "Frontend"
    keywords = ['estado', 'redux', 'zustand', 'context', 'store', 'recoil', 'state management']

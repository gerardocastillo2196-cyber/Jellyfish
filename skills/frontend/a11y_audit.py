"""Skill: A11Y Audit — Migración automática de 18_a11y_audit.md."""
from core.skills.base import BaseSkill


class A11yAuditSkill(BaseSkill):
    """A11Y Audit."""

    name = "A11Y Audit"
    agency = "Frontend"
    keywords = ['accesibilidad', 'a11y', 'wcag', 'aria', 'screen reader', 'contraste', 'alt']

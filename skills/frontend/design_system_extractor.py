"""Skill: Design System Extractor — Migración automática de 19_design_system_extractor.md."""
from core.skills.base import BaseSkill


class DesignSystemExtractorSkill(BaseSkill):
    """Design System Extractor."""

    name = "Design System Extractor"
    agency = "Frontend"
    keywords = ['design system', 'tokens', 'paleta', 'tipografía', 'componentes', 'figma']

    def get_instructions(self) -> str:
        return """## Design System Extractor

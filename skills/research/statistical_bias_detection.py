"""Skill: Statistical Bias Detection — Migración automática de 36_statistical_bias_detection.md."""
from core.skills.base import BaseSkill


class StatisticalBiasDetectionSkill(BaseSkill):
    """Statistical Bias Detection."""

    name = "Statistical Bias Detection"
    agency = "Research"
    keywords = ['sesgo', 'bias', 'estadística', 'distribución', 'sampling', 'confounders']

    def get_instructions(self) -> str:
        return """## Statistical Bias Detection

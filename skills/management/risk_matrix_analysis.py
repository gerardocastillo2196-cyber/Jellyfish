"""Skill: Risk Matrix Analysis — Migración automática de 05_risk_matrix_analysis.md."""
from core.skills.base import BaseSkill


class RiskMatrixAnalysisSkill(BaseSkill):
    """Risk Matrix Analysis."""

    name = "Risk Matrix Analysis"
    agency = "Management"
    keywords = ['riesgo', 'matriz', 'impacto', 'probabilidad', 'mitigación', 'contingencia']

    def get_instructions(self) -> str:
        return """## Risk Matrix Analysis

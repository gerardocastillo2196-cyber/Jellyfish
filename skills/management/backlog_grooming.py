"""Skill: Backlog Grooming — Migración automática de 01_backlog_grooming.md."""
from core.skills.base import BaseSkill


class BacklogGroomingSkill(BaseSkill):
    """Backlog Grooming."""

    name = "Backlog Grooming"
    agency = "Management"
    keywords = ['backlog', 'grooming', 'refinamiento', 'historia de usuario', 'priorización']

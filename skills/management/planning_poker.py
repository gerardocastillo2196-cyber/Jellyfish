"""Skill: Planning Poker — Migración automática de 03_planning_poker.md."""
from core.skills.base import BaseSkill


class PlanningPokerSkill(BaseSkill):
    """Planning Poker."""

    name = "Planning Poker"
    agency = "Management"
    keywords = ['planning poker', 'estimación', 'puntos de historia', 't-shirt', 'fibonacci']
